...
%%                         your residence card.
\eauthor{Hiroya}{Uekita} % 日本人学生（名-姓の順であることに注意！）
%\eauthori{John Smith} % for International students
\idnumber{20622003}
\deadline{2022}{2}{8} % 提出日{西暦年}{月}{日}
...
\etitle{Automatic generation of perforated hints to support C program learning}
%% 以下，指導教員名の前の数字は職名を表す
...
\advisor{1}{水野　修} % 主任指導教員
\secondadvisor{2}{崔　恩瀞} % （必要ならば）指導教員(if needed)
